    ...
    <div class="tablist">
        <ul id="tablist">
            ...
            <ul class="nav navbar-right user_dropdown">
                ...
                @guest
                <li><a href="https://viasocket.com/login?token_required=true&redirect_uri=http://127.0.0.1:8000/socketlogin">Login</a></li>
                <li><a href="https://viasocket.com/singup?token_required=true&redirect_uri=http://127.0.0.1:8000/socketlogin">Register</a></li>
                @else
                <li class="dropdown">
